                    ...
                    messages: [
                        {
                            ...
                            content: {
                                content_type: "text",
                                parts: ["You know the format for google calendar event URLs. Generate a google calendar URL using the event details below. Be sure to include the event title, location, date, and time. Simply give the URL without any other text: "+question]
                            }
                        }
                    ],
